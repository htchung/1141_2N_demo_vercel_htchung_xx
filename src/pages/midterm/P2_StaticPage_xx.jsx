          ...
          <div className='directory-menu'>
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link to='/midterm/hats_xx' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link to='/midterm/jackets_xx' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link to='/midterm/sneakers_xx' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link to='/midterm/womens_xx' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link to='/midterm/mens_xx' className='content'>
